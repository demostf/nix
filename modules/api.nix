      ...
      locations = {
        "~ ^(.+?\\.php)(/.*)?$" = {
          extraConfig = ''
            ...
            fastcgi_param  SCRIPT_FILENAME ${apiPkg}/share/php/demostf-api/src/public/index.php;
        ...
        "= /upload" = {
          extraConfig = ''
            fastcgi_pass   unix:${fpmCfg.socket};
            fastcgi_index  index.php;
            fastcgi_param  SCRIPT_FILENAME ${apiPkg}/share/php/demostf-api/src/public/upload.php;
            include ${pkgs.nginx}/conf/fastcgi_params;
            client_max_body_size 250m;
          '';
        };
